...
let update msg model =
    ...
    | PostcodeChanged p ->
        { model with
            ...
            ValidationError = if Validation.isValidPostcode p then None else Some("Invalid postcode.")
        },
        Cmd.none
...
module ViewParts =
    [<ReactComponent>]
    let reactTest dispatch (text: string) = Html.div [
        Svg.text text
        Html.button [
            prop.text "What will I do? tehehehe"
